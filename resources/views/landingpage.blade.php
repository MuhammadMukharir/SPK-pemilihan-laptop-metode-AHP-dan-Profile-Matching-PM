...
<body>
  ...
  <section class="hero">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <a class="hero-brand" href="index.html" title="Home"><img alt="Bell Logo" src="{{ asset('landingpage/assets/img/laptop-symbol-azy-mstile-310x310.png') }}" width="200" height="200"></a>
        </div>
      </div>
